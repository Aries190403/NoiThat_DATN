            ...
            <div class="item" style="background-image:url({{ asset('frontend/assets/images/gallery-2.jpg)') }}">
                <div class="box">
                    <div class="container">
                        ...
                        <div class="animated" data-animation="fadeInUp">
                            <a href="/shop" target="_blank" class="btn btn-main"><i class="icon icon-cart"></i> Buy
                                now</a>
                        </div>
                    </div>
                </div>
        ...
        <ul class="stretcher">
            ...
            @foreach ($roomCategory as $item)
                ...
                @if (isset($content->imgThumbnail))
                    ...
                    @endphp
                    {{-- @dump($content) --}}
                    <li class="stretcher-item" style="background-image:url({{ asset($content->imgThumbnail) }});">
                        <!--logo-item-->
                        <div class="stretcher-logo">
                            <div class="text">
                                <span class="f-icon {{ $content->icon }}"></span>
