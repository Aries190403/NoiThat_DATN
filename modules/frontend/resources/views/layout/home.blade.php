...
@section('content')
                        ...
                        <div class="col-md-4 col-xs-6">
                            <article>
                                ...
                                <div class="figure-grid">
                                    ...
                                    <div class="image">
                                        <a href="#productid1" class="mfp-open">
                                            <img src="{{ asset('frontend/assets/images/product-5.png')}}" alt="" width="360" />
                                        </a>
                                    </div>
                                    <div class="text">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <article>
                                ...
                                <div class="figure-grid">
                                    <div class="image">
                                        <a href="#productid1" class="mfp-open">
                                            <img src="{{ asset('frontend/assets/images/product-6.png')}}" alt="" width="360" />
                                        </a>
                                    </div>
                                    <div class="text">
                    ...
                    <div class="popup-main mfp-hide" id="productid1">
                        ...
                        <div class="product">
                            ...
                            <div class="owl-product-gallery">
                                <img src="{{ asset('frontend/assets/images/product-1.png')}}" alt="" width="640" />
                                <img src="{{ asset('frontend/assets/images/product-2.png')}}" alt="" width="640" />
                                <img src="{{ asset('frontend/assets/images/product-3.png')}}" alt="" width="640" />
                                <img src="{{ asset('frontend/assets/images/product-4.png')}}" alt="" width="640" />
                            </div>
            ...
            <section class="stretcher-wrapper">
                ...
                <ul class="stretcher">
                    ...
                    <li class="stretcher-item" style="background-image:url({{ asset('frontend/assets/images/gallery-1.jpg);')}}">
                        <!--logo-item-->
                    ...
                    <li class="stretcher-item" style="background-image:url({{ asset('frontend/assets/images/gallery-2.jpg);')}}">
                        <!--logo-item-->
                        <div class="stretcher-logo">
                            <div class="text">
                    ...
                    <li class="stretcher-item" style="background-image:url({{ asset('frontend/assets/images/gallery-3.jpg);')}}">
                        <!--logo-item-->
                        <div class="stretcher-logo">
                            <div class="text">
                    ...
                    <li class="stretcher-item" style="background-image:url({{ asset('frontend/assets/images/gallery-4.jpg);')}}">
                        <!--logo-item-->
                        <div class="stretcher-logo">
                            <div class="text">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <article>
                                <a href="article.html">
                                    <div class="image" style="background-image:url({{ asset('frontend/assets/images/blog-8.jpg)')}}">
