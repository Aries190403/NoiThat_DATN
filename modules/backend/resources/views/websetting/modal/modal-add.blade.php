                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="phone" style="font-weight: bold;">Phone <span
                                    style="color: red;">*</span></label>
                            <input type="text" class="form-control" name="phone" id="phone"
                                placeholder="your phone" required maxlength="10" pattern="\d{10}"
                                oninput="this.value=this.value.replace(/[^0-9]/g,'');" style="margin-bottom: 15px;" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control time-picker" id="open_time" placeholder="Select time" type="text"
                            name="open_time" />
                    </div>

                    <div class="col-md-6">
                        <label for="close_time" style="font-weight: bold;">Close Time</label>
                        <input class="form-control time-picker" id="close_time" placeholder="Select time" type="text"
                            name="close_time" />
                    </div>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="form-group">
                            <label for="facebook_link" style="font-weight: bold;">Facebook link <span
                                    style="color: red;">*</span></label>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="form-group">
                            <label for="youtube_link" style="font-weight: bold;">YouTube link <span
                                    style="color: red;">*</span></label>
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="form-group">
                            <label for="map_link" style="font-weight: bold;">Map link <span
                                    style="color: red;">*</span></label>
