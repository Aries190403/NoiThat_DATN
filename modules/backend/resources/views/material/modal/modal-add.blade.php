<div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content" id="exampleModal">
        ...
        <div class="modal-body">
            <form id="kt_modal_material_form" action="{{route('admin-material-store')}}" method="post">
                @csrf
                <div class="row">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btn-modal-material">Add material</button>
                </div>
            </form>
        </div>
    </div>
